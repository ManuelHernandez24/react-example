            ...
            <Col lg="6">
              <div className="product__details mt-4">
                ...
                <div className="product__rating d-flex gap-5 mb-3 align-items-center">
                  ...
                  <p>(<span>{avgRating}</span> calificaciones)</p>
                </div>
                <span className='product__price'>${price}</span>
                <p className='mt-3'>{shortDesc}</p>
                <motion.button whileTap={{ scale: 1.1 }} onClick={addItemHandler} className="buy__btn text-white">Agregar al carrito</motion.button>
              </div>
            </Col>
          </Row>
        </Container>
          ...
          <Row>
            <Col lg="12">
              <div className="tab__wrapper d-flex align-items-center gap-5">
                <h6 className={tab === 'desc' ? 'active' : ''} onClick={() => setTab('desc')}>Descripcion</h6>
              ...
              <div className="review__form">
                ...
                <form action="" onSubmit={submitHandler}>
                  <div className="form__group">
                    <input type="text" placeholder='Ingresa tu nombre' ref={userNameRef} />
                  </div>
                  ...
                  <div className="form__group">
                    <textarea rows='4' placeholder='Deja tu mensaje...' ref={userMsgRef} />
                  </div>
                  <button className="buy__btn text-white mt-3">Enviar</button>
                </form>
              </div>
            </Col>
            <Col lg="12" className='mt-5'>
              <h2 className='related__title'>Cosas que te pueden gustar</h2>
            </Col>

  ...
  return (
    <Helmet title='shop'>
          ...
          <Row>
            <Col lg="3" md="6">
              <div className="filter__widget">
                <select onChange={filterHandler}>
                  ...
                  <option value="mobile">Collares</option>
                  <option value="sofa">Pendientes</option>
                  <option value="wireless">Pulseras</option>
                  <option value="chair">Anillos</option>
                  <option value="watch">Aretes</option>
                </select>
              </div>
            </Col>
            <Col lg="3" md="6">
            ...
            <Col lg="6" md="12">
              <div className="search__box w-100">
                <input type="text" placeholder='Buscar ....' onChange={searchHandler} />
      ...
      <Container>
        <Row>
          {
            productsData.length === 0 ? <h1 className='text-center fs-5 mb-5 fw-700'>Ningun producto encontrado!</h1> :

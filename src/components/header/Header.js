            ...
            <Container>
                <Row>
                    <div className="nav__wrapper">
                        <div className="logo">
                            <img onClick={() => { navigate("/") }} src="https://firebasestorage.googleapis.com/v0/b/mujuke-6f0ea.appspot.com/o/logo.png?alt=media&token=02aa3e21-80e6-48ae-89fd-507908181b57" alt="logo" />
                            <div>
                                <h1 className='text-dark' onClick={() => { navigate("/") }}>GLAMOUR'S GOLD</h1>
                                {/* <p>Since 1992</p> */}
                            </div>
                        </div>
